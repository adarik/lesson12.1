...
from utils import get_settings, get_candidates, get_candidate_by_id
...
def page_search_by_name():
    ...
    return render_temlate("search.html", cans=cans, cans_count=cans_count)

@app.route('/skill/skill_name>')
def page_search_by_skill(skill_name):
    cans = get_candidates_by_skill(skill_name)
    cans_count = Len(cans)
